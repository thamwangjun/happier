...
- [x] 10-03-PLAN.md — E2E test: reconnect.resilience.e2e.test.ts asserting reconnect-resume payload, replay-complete receipt, and zero duplicate seqs
- [x] 10-04-PLAN.md — WAL contention stress test: buffer.walContention.stress.test.ts with 200 concurrent writes via Promise.all
